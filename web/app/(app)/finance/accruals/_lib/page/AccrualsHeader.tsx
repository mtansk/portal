...
export default function AccrualsHeader({
    searchParams,
    page,
    ...
    const [dialogObject, setDialogObject] = useState<"accrual" | "sheet">(
        "accrual",
    );
        ...
        <>
            {dialogIsOpen && (
                ...
                >
                    <AddModal
                        objectPath={
                            dialogObject === "accrual" ? `/finance/accruals` : (
                                "/sheets"
                            )
                        }
                        _users={users}
                        _depts={depts}
                        useSheet={dialogObject === "sheet"}
                    />
                </ModalPortal>
            )}
            <div className={styles.finance_header_div}>
                <div className={styles.main_div}>
                    <div className={styles.title}>Начисления</div>
                    ...
                    <div className={styles.add_div}>
                        <Button
                            type="nav"
                            colors="nav-blue"
                            innerContent="Добавить начисление"
                            onClick={() => {
                                setDialogObject("accrual");
                        ...
                        <Button
                            type="nav"
                            colors="nav-purple"
                            innerContent="Добавить смену"
                            onClick={() => {
                                setDialogObject("sheet");
                                setDialogIsOpen(true);
                            }}
                        />
                    </div>
